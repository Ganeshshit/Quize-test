        ...
        return (
            <TrainerLayout>
                <div className="flex flex-col items-center justify-center py-20 min-h-[60vh]">
                    ...
                    <p className="text-sm font-bold text-gray-900 mb-2">Failed to Load Quiz</p>
                    <p className="text-xs text-gray-500 mb-6 text-center max-w-md">{error}</p>
                    <button
                        onClick={() => window.location.reload()}
                        className="px-6 py-2.5 bg-[#0A0A0A] hover:bg-black text-white text-sm font-bold rounded-xl transition-all"
                    >
                        Retry
                    </button>
                </div>
