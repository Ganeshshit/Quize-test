...
const TrainerProfile = () => {
    ...
    /**
     * Populate the profile from the authenticated user supplied
     * by the central authentication state.
     *
     * No hardcoded identity or direct localStorage access is used here.
     */
    useEffect(() => {
        if (!user) {
            return;
    ...
    // Extract initials dynamically based on the authenticated user's name
    ...
    const handleProfileSubmit = async (e) => {
        ...
        if (!trainerData.name.trim() || !trainerData.email.trim()) {
    ...
    const handleUpdatePassword = async (e) => {
        ...
        try {
            // Password API integration is not part of the existing usersAPI contract.
            // Keep the current UI behavior until the backend password endpoint is confirmed.
                            ...
                            {isEditingProfile ? (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-full py-2.5 mt-2 bg-[#0A0A0A] hover:bg-black text-white text-sm font-bold rounded-xl shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                                    >
                                        {savingProfile ? (
                                            "Saving..."
                                        ) : (
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-gray-900">
                                                {trainerData.email || "Not available"}
                                            </p>
                                        </div>
                                    </div>
